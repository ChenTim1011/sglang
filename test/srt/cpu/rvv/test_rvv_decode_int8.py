...
class TestDecodeAttentionInt8CPU(unittest.TestCase):
    ...
    def _run_decode_int8_test(self, num_heads, head_dim, seq_len, num_requests, dtype):
        """
    ...
    def test_decode_int8_gqa(self):
        ...
        # If not supported, this test will help identify the gap
        for dtype in [torch.float16, torch.bfloat16]:
            self._run_decode_int8_test(
                num_heads=32, head_dim=64, seq_len=256, num_requests=4, dtype=dtype
            )
