...
The measurements below were collected from a clean source copy on a Banana Pi
BF3 at the historical implementation revision `0026101a02`. The current branch
replays that integration on a newer SGLang base; these measurements have not yet
been rerun at the rebased branch head.
