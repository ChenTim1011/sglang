...
# Auto-detect VLEN from /proc/cpuinfo (populated when cmake runs on the target machine).
...
add_compile_options(-march=rv64gcv_zvfh -mabi=lp64d -mrvv-vector-bits=${RVV_VECTOR_BITS})
add_compile_definitions(CPU_CAPABILITY_RVV)

# L1 cache size (KB) for K-tiling KB calculation.
# Override at configure time: cmake ... -DRVV_L1_CACHE_KB=64
