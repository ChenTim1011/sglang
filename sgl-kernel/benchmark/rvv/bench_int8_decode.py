"""Benchmark RVV vs torch_native INT8 decode attention."""
...
INT8_CONFIGS = [
    BenchmarkConfig(1, 12, 128, 128, "INT8 decode BS=1 seq=128"),
    BenchmarkConfig(4, 12, 128, 128, "INT8 decode BS=4 seq=128"),
    BenchmarkConfig(1, 12, 128, 512, "INT8 decode BS=1 seq=512"),
]

CI_CONFIGS = [
    BenchmarkConfig(1, 12, 128, 32, "CI INT8 decode"),
]
