...
INT8_CONFIGS = [
    BenchmarkConfig(1, 128, 128, 32, 64, "prefill", "LLaMA-1B INT8 prefill Seq=128"),
    BenchmarkConfig(1, 512, 512, 32, 64, "prefill", "LLaMA-1B INT8 prefill Seq=512"),
    BenchmarkConfig(
        1, 512, 128, 32, 64, "extend", "LLaMA-1B INT8 extend Seq=512 Ext=128"
    ),
]

CI_CONFIGS = [
    BenchmarkConfig(1, 32, 8, 32, 64, "extend", "CI LLaMA-1B INT8 extend"),
]
