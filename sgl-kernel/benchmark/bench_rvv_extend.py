"""
Benchmark script for RVV extend attention kernel (FP16).
...
Usage:
    python3 bench_rvv_extend.py [--quick]
"""
...
STANDARD_CONFIGS = [
    ...
    BenchmarkConfig(1, 2048, 2048, 8, 64, "prefill", "Prefill (Seq=2048)"),
]
...
def main():
    parser = argparse.ArgumentParser(
        description="Benchmark RVV Extend Attention (FP16)"
    )
    ...
    print("=" * 60)
    print("RVV Extend Attention Benchmark (FP16)")
    print("=" * 60)
